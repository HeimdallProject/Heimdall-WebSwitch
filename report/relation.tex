...
$ sh config.sh 
\end{lstlisting}
Per eseguire un test bisogna modificare la configurazione del cluster, specificando almeno una macchina all'interno del file \emph{code/config/server\_config.conf}, scrivendo indirizzo ip e nome del server.
\\\\

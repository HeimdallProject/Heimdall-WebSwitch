...
% Come abbiamo spiegato nel paragrafo del Pool Manager, questo è un thread del processo principale. Il suo compito ricordiamo è quello di gestire i file descriptor delle connessioni accettate dal main thread. Abbiamo scelto di avere un thread dedicato per questo compito perché volevamo lasciare il più possibile il main thread del processo principale libero da compiti che potevano rallentare l'accettazione delle nuove connessioni. In effetti siamo riusciti ad ottenere questo ma...
